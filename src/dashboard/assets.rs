        ...
        (
            ...
            [
                ...
                (
                    ...
                    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; connect-src 'self' ws: wss:; font-src 'self' data:; frame-src 'self' https://p2pclaw.com https://*.p2pclaw.com".to_string(),
                ),
            ],
            file.data.to_vec(),
        )
