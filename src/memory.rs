...
const QUERY_EXPANSION_ENABLED_ENV: &str = "AGENTHALO_MEMORY_QUERY_EXPANSION";
const QUERY_EXPANSION_LLM_ENV: &str = "AGENTHALO_MEMORY_QUERY_EXPANSION_LLM";
const QUERY_EXPANSION_MODEL_ENV: &str = "AGENTHALO_MEMORY_QUERY_EXPANSION_MODEL";
...
fn expand_query_with_llm(query: &str) -> Option<String> {
    ...
    let response = crate::halo::http_client::post_with_timeout(
